    ...
    >
      <div style={{ width: "min(980px, 100%)" }}>
        ...
        <p style={{ marginTop: 14, opacity: 0.7, lineHeight: 1.6, maxWidth: 760 }}>
          SIMPLE is the in-OS execution interface on MatrixOS. It is designed as a single surface:
          one flow at a time, minimal background activity, and a consistent audit posture.
        </p>
        ...
        >
          ...
          >
            ...
            <p style={{ marginTop: 10, opacity: 0.65, lineHeight: 1.55, fontSize: 13 }}>
              Consequential actions generate a receipt (REGISTRO) or a security trace event (RASTRO)
              for audit integrity.
            </p>
          </section>
